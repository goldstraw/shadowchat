...
class V2ConversationItemShapeTest {
  ...
  private class FakeConversationContext(
    ...
    override val isShadowChatEnabled: Boolean = false
    override val shadowChatRegularPassword: CharArray? = null
    override val shadowChatHiddenPassword: CharArray? = null
