...
public class ComposeText extends EmojiEditText {
  ...
  @Nullable private MessageSendType messageSendType;
  @Nullable private CharSequence    composeHintOverride;
  ...
  public void setMessageSendType(MessageSendType messageSendType) {
    ...
    String composeHint = getComposeHint(messageSendType);

    if (isLandscape()) setImeActionLabel(composeHint, EditorInfo.IME_ACTION_SEND);
  ...
  public void setComposeHintOverride(@Nullable CharSequence hintOverride) {
    this.composeHintOverride = hintOverride;

    if (messageSendType != null) {
      setMessageSendType(messageSendType);
    } else if (hintOverride != null) {
      setHint(hintOverride.toString());
    }
  }

  private @NonNull String getComposeHint(@NonNull MessageSendType messageSendType) {
    if (composeHintOverride != null) {
      return composeHintOverride.toString();
    }
    return getContext().getString(messageSendType.getComposeHintRes());
  }
